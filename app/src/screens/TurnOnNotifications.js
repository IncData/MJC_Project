...
export default class TurnOnNotifications extends Component {
  ...
  render() {
    ...
    const notifyBtnColor = pressNotifyBtn ? colors.green02 : colors.pink01;
    return (
      <View style={styles.wrapper}>
        <View style={styles.content}>
          ...
          Nous pouvons vous informer lorsque quelqu'un vous envoie un message, 
          ou vous informer de toute autre activité importante.
          </Text>
          <TouchableHighlight
            style={[
  ...
  Oui, me notifier
          ...
          >
            <Text style={[{ color: colors.pink01 }, styles.buttonText]}>
  Sauter
            </Text>
          </TouchableHighlight>
        </View>
